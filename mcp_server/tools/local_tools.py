"""Local (non-bridge) tool handlers."""
...
class LocalToolsMixin:
    """Mixin providing local (non-bridge) tool handlers."""

    process_registry: ProcessRegistry

    def _get_local_definitions(self) -> dict[str, ToolDefinition]:
        return {
